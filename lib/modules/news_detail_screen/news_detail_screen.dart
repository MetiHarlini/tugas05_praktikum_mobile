    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.network(
              "https://i.postimg.cc/xC2h7dp6/inspirasi-menu-ramadhan-sahur-buka-puasa-30-hari-2023.jpg",
              ),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 24),
                child: Column(
                  children: [
                   const SizedBox(height: 10),
                    Row(
                      ...
                      children: const [
                        Text(
                          '30 Hari Inspirasi Menu Ramadhan',
                           style:
                            TextStyle(fontWeight: FontWeight.bold, fontSize: 20),
                        )
                      ],
                    ...
                    const SizedBox(height: 10),
                  const Text(
                    'Resep Sahur Dan Buka Puasa Di Bulan Ramadhan',
                    maxLines: 10,
                    textAlign: TextAlign.justify,
                    overflow: TextOverflow.ellipsis,
                  )
